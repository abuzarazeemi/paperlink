<template>
  <div class="py-2 flex items-center text-black gap-4 bg-white">
    ...
    <ShareFilesModal :pdfContainerDimension="pdfContainerDimension" :userFile="file" v-model="showShareCompanyFiles" @qrLoad="showQrcodeFileFunc"/>
    ...
    <RemoveFileModal @isDeletedFunc="isDeletedFunc" :fileId="file.id" v-model="showRemoveModal"/>
